...
curl -v \
  ...
  https://api.github.com/repos/matejvasek/faas/pulls \
  -d "{\"title\":\"chore: update Quarkus Platform to $LATEST_PLATFORM\",\"body\":\"chore: update Quarkus Platform to $LATEST_PLATFORM\",\"head\":\"matejvasek:$BRANCH\",\"base\":\"master\"}"