...
func NewDeleteCmd(newRemover func(ns string, verbose bool) (bosonFunc.Remover, error)) *cobra.Command {
...
var deleteCmd = NewDeleteCmd(func(ns string, verbose bool) (bosonFunc.Remover, error) {
