...
func TestGitlab(t *testing.T) {
	...
	glabEnv := setupGitlabEnv(t, "gitlab.127.0.0.1.sslip.io", "root", "/xAadUZu2B2STcL3OhMHqbwAW9fWQC9bupgkhdqLtRQ=")
	...
	buildDoneCh := waitBuildCompletion(t, glabEnv.ProjectName)
...
func setupGitlabEnv(t *testing.T, host, username, password string) gitlabEnv {
	...
	newSettings := &gitlab.UpdateSettingsOptions{
		OutboundLocalRequestsAllowlistRaw: p("pac-ctr.127.0.0.1.sslip.io"),
	}
...
func waitBuildCompletion(t *testing.T, name string) <-chan struct{} {
